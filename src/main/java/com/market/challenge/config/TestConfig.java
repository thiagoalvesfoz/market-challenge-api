package com.market.challenge.config;
...
import com.market.challenge.model.enumerations.OrderStatus;
import com.market.challenge.repositories.CategoryRepository;
import com.market.challenge.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		o1.setPayment(pay1); //-> classe depente não usa repository próprio.
